...
public:
    ...
    void processEyeDomeLighting(VkCommandBuffer _cmdBuffer, const EyeDomeLighting& edlSettings, VkDescriptorSet descSetColor, VkDescriptorSet descSetDepth, VkExtent2D extent);
