...
public:
    ...
    void processSSAO(VkCommandBuffer _cmdBuffer, const PostRenderingSSAO& ssaoSettings, VkDescriptorSet descSetColor, VkDescriptorSet descSetDepth, VkExtent2D extent);
