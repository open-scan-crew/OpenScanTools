...
public:
    ...
    void setConstantHDR(float transparency, bool substract, bool noFlash, float kneeStart, float kneeSoftness, VkExtent2D screenSize, Color32 background, VkCommandBuffer _cmdBuffer);
