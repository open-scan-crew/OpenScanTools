...
public:
    ...
    void setConstantHDR(float transparency, bool substract, bool reduceFlash, EnhanceContrastMode mode, float flashExposure, VkExtent2D screenSize, Color32 background, VkCommandBuffer _cmdBuffer);
