...
public:
    ...
    void setConstantGapFillingSettings(bool gapOnlyEnabled, float gapDepthThreshold, float falloffStrength, float falloffExponent, float varianceThreshold, VkCommandBuffer _cmdBuffer);
