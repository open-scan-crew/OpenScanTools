...
void PostRenderer::setConstantGapFillingDensityAuto(bool enabled, VkCommandBuffer _cmdBuffer)
{
    int enabledFlag = enabled ? 1 : 0;
    h_pfn->vkCmdPushConstants(_cmdBuffer, m_fillingPipelineLayout, VK_SHADER_STAGE_COMPUTE_BIT, 60, 4, &enabledFlag);
}
