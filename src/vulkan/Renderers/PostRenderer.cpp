...
void PostRenderer::setConstantHDR(float opacity, bool substract, bool noFlash, bool flashAdvanced, float highlightKneeStart, float highlightKneeSoftness, VkExtent2D screenSize, Color32 background, VkCommandBuffer _cmdBuffer)
{
