...
void DisplayPresetManager::applyPreset(const DisplayPreset& preset)
{
	...
	m_dataDispatcher.updateInformation(new GuiDataRenderTransparencyOptions(params.m_negativeEffect, params.m_reduceFlash, params.m_flashAdvanced, params.m_highlightKneeStart, params.m_highlightKneeSoftness, 0.f, m_focusCamera), this);
