...
void GenericPropertiesHead::updateType(ElementType objectType)
{
	...
	m_ui.AuthorInfield->setVisible(true);

	m_ui.IndexLabel->setVisible(true);
	m_ui.IndexInfield->setVisible(true);
	...
	m_ui.IdentifierLabel->setVisible(true);
	m_ui.IdentifierInfield->setVisible(true);

	m_ui.colorLabel->setVisible(true);
	m_ui.colorPicker->setVisible(true);
	...
	switch (objectType)
	{
		...
		{
			m_ui.colorPicker->setVisible(false);
			m_ui.colorLabel->setVisible(false);

			m_ui.IdentifierInfield->setVisible(false);
			m_ui.IdentifierLabel->setVisible(false);

			m_ui.IndexInfield->setVisible(false);
			m_ui.IndexLabel->setVisible(false);
			break;
		}
		case ElementType::Scan:
		{
			...
			m_ui.AuthorInfield->setVisible(false);
			...
			m_ui.NameInfield->setReadOnly(true);
			break;
		}
