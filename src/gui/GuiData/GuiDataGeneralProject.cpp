...
GuiDataColorBalanceDialogDisplay::GuiDataColorBalanceDialogDisplay(bool hasRGB, bool hasIntensity, bool hasBothComponents)
    : m_hasRGB(hasRGB)
    , m_hasIntensity(hasIntensity)
    , m_hasBothComponents(hasBothComponents)
{
}
