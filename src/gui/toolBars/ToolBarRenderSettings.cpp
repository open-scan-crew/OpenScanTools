...
void ToolBarRenderSettings::onActiveCamera(IGuiData* idata)
{
	...
	if (displayParameters.m_roundPoint != m_ui.checkBox_roundPoint->isChecked())
...
{
	m_dataDispatcher.updateInformation(new GuiDataRenderRoundPoint(value == Qt::Checked, m_focusCamera), this);
}
