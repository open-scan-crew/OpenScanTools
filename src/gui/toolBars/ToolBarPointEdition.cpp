    ...
    , m_dataDispatcher(dataDispatcher)
{
    ...
    QObject::connect(m_ui.toolButton_colorDenoiseFilter, &QToolButton::clicked, this, &ToolBarPointEdition::slotColorDenoiseFilter);
...
void ToolBarPointEdition::slotColorDenoiseFilter()
{
    m_dataDispatcher.sendControl(new control::exportPC::StartColorDenoiseFilter());
}
