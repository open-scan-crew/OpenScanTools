...
#define MULTITHREADED_CALC_JSON_KEY "multithreaded_calc"
...
namespace Config
{
	...
	bool isMultithreadedCalculation()
	{
	...
	bool setMultithreadedCalculation(bool multithreaded)
	{
		try {
			jsonConfig[MULTITHREADED_CALC_JSON_KEY] = multithreaded;
			return saveConfigFile(filePath);
		}
		catch (...)
		{
