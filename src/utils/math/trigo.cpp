...
glm::mat4 tls::math::getTransformMatrix(const double translation[3], const double q[4])
{
    double xx = q[0] * q[0];
    double yy = q[1] * q[1];
    double zz = q[2] * q[2];
...
glm::dmat4 tls::math::getTransformDMatrix(const double translation[3], const double q[4])
{
    double xx = q[0] * q[0];
    double yy = q[1] * q[1];
    double zz = q[2] * q[2];
...
glm::mat4 tls::math::getInverseTransformMatrix(const double translation[3], const double q[4])
{
    double xx = q[0] * q[0];
    double yy = q[1] * q[1];
    double zz = q[2] * q[2];
...
glm::dmat4 tls::math::getInverseTransformDMatrix(const double translation[3], const double q[4])
{
    double xx = q[0] * q[0];
    double yy = q[1] * q[1];
    double zz = q[2] * q[2];
...
glm::mat4 tls::math::getTransformMatrix(const double translation[3], const double q[4], const double scale[3])
{
...
glm::mat4 tls::math::getInverseTransformMatrix(const double translation[3], const double q[4], const double scale[3])
{
