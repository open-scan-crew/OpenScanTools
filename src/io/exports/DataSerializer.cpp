...
void ExportRenderingParameters(nlohmann::json& json, const RenderingParameters& data)
{
    ...
    json[Key_Billboard_Rendering] = { params.m_billboard.enabled, params.m_billboard.feather, params.m_billboard.adaptiveSizeEnabled, params.m_billboard.adaptiveSizeStrength };
    json[Key_Eye_Dome_Lighting] = { params.m_eyeDomeLighting.enabled, params.m_eyeDomeLighting.strength, params.m_eyeDomeLighting.radius, params.m_eyeDomeLighting.bias };
...
void ExportViewPointData(nlohmann::json& json, const ViewPointData& data)
{
        ...
        json[Key_Billboard_Rendering] = { displayParams.m_billboard.enabled, displayParams.m_billboard.feather, displayParams.m_billboard.adaptiveSizeEnabled, displayParams.m_billboard.adaptiveSizeStrength };
        json[Key_Eye_Dome_Lighting] = { displayParams.m_eyeDomeLighting.enabled, displayParams.m_eyeDomeLighting.strength,
                displayParams.m_eyeDomeLighting.radius, displayParams.m_eyeDomeLighting.bias };
