...
void ExportRenderingParameters(nlohmann::json& json, const RenderingParameters& data)
{
    ...
    json[Key_Adaptive_Point_Size_Enable] = params.m_adaptivePointSize;
    json[Key_Adaptive_Point_Dist_Min] = params.m_adaptivePointMinDistance;
    json[Key_Adaptive_Point_Dist_Max] = params.m_adaptivePointMaxDistance;
