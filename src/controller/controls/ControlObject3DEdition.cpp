...
namespace control
{
    namespace object3DEdition
    {
        ...
        */
        ...
        {
            return (ControlType::setObject3DCenterEdit);
        }
        ...
        */
        ...
        {
            return (ControlType::setObject3DSizeEdit);
        }
        ...
        */
        ...
        {
            return (ControlType::setObject3DRotationEdit);
        }
        ...
        */
        ...
        {
            return ControlType::setObject3DTransformationEdit;
        }
        ...
        */
        ...
        {
            return (ControlType::addObject3DExtrudeEdit);
        }
        ...
        */
        ...
        ManipulateObjects::~ManipulateObjects()
        {}
        ...
        {
            std::unordered_set<SafePtr<AGraphNode>> toActualize;
            glm::dvec3 manipCenter;

            {
                ReadPtr<ManipulatorNode> rManip = m_manip.cget();
                if (!rManip)
                    return;
                manipCenter = rManip->getTranslation();
            }
        ...
        {
            return ControlType::addObject3DTransformationEnd;
        }
        ...
        */
        ...
        {
            return ControlType::setSphereRadius;
        }
