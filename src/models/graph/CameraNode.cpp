    ...
    , m_speed(1.0)
{
    ...
    registerGuiDataFunction(guiDType::renderRoundPoint, &CameraNode::onRenderRoundPoint);
...
void CameraNode::onRenderRoundPoint(IGuiData* data)
{
    m_roundPoint = static_cast<GuiDataRenderRoundPoint*>(data)->m_roundPoint;
}
