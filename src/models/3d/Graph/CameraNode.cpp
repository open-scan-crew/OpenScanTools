...
void CameraNode::alignView(const AlignView & align, const tls::BoundingBox & sceneBBox, bool isBboxEmpty)
{
    double midX;
    double midY;
    ...
    if (useUo && align != AlignView::Reset) {
    ...
    case AlignView::Reset:
        ...
        else
        {
            ...
            lookAt(glm::dvec3(sceneBBox.xMin, sceneBBox.yMin, sceneBBox.zMin), 0);
            //static_cast<CameraNode*>(m_cam)->lookAt(glm::dvec3(sceneBBox.xMin, sceneBBox.yMin, sceneBBox.zMin));
        }
        return;
