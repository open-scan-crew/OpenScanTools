...
public:
    ...
    bool computeColorBalanceHistogram(tls::ScanGuid scanGuid, const TransformationModule& modelMat, const ClippingAssembly& clippingAssembly, double cellSize, bool useColor, bool useIntensity, ColorBalanceHistogramMap& histogram, const ProgressCallback& progress = {});
    bool applyColorBalanceAndWrite(tls::ScanGuid scanGuid, const TransformationModule& modelMat, const ClippingAssembly& clippingAssembly, const std::vector<ColorBalanceCorrectionMap>& correctionLevels, double baseCellSize, double beta, bool applyColor, bool applyIntensity, IScanFileWriter* outScan, const ProgressCallback& progress = {});
