...
public:
    ...
    bool denoiseColorsAndWrite(tls::ScanGuid scanGuid, const TransformationModule& modelMat, const ClippingAssembly& clippingAssembly, int kNeighbors, int strength, double radiusFactor, int iterations, bool preserveLuminance, IScanFileWriter* outScan, uint64_t& processedPoints, const ProgressCallback& progress = {});
