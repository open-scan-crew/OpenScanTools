...
public:
    ...
    bool collectPointsInGeometricBoxForScan(const tls::ScanGuid& scanGuid, const GeometricBox& box, const TransformationModule& modelMat, const ClippingAssembly& clippingAssembly, std::vector<PointXYZIRGB>& result);
