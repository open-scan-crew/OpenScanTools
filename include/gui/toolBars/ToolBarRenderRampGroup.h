...
private:
	...
	void updateTemperatureScaleStatus(IGuiData* data);
...
private:
	...
	std::filesystem::path m_temperatureScalePath;
	bool m_temperatureScaleValid = false;
	bool m_temperatureScaleFileFound = false;
