...
private:
	...
	void onRenderGapFillingGapOnly(IGuiData* data);
	void onRenderGapFillingFalloffStrength(IGuiData* data);
	void onRenderGapFillingFalloffExponent(IGuiData* data);
	void onRenderGapFillingVarianceThreshold(IGuiData* data);
...
private slots:
	...
	void slotGapFillingGapOnlyChanged(int state);
	void slotGapFillingFalloffStrengthChanged(double value);
	void slotGapFillingFalloffExponentChanged(double value);
	void slotGapFillingVarianceChanged(double value);
