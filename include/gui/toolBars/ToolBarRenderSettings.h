...
private:
    ...
    void showSaturationLuminance();
        ...
        void sendAdaptivePointSize();
        void updateAdaptivePointUiState(bool adaptiveEnabled);
...
private slots:
	...
	void slotTransparencyValueChanged(int value);
        ...
        void slotAdaptivePointFillingChanged(int value);
        void slotAdaptivePointFillingSpinChanged(double value);
        void slotDistanceAttenuationToggled(int state);
        void slotDistanceAttenuationChanged(int value);
        void slotDistanceAttenuationSpinChanged(double value);
