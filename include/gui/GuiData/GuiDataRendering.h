...
{
public:
	GuiDataRenderTransparencyOptions(bool negativeColors, bool reduceFlash, float kneeStart, float kneeSoftness, float hlt, SafePtr<CameraNode> camera);
