...
{
public:
    GuiDataRenderTransparencyOptions(bool negativeColors, bool reduceFlash, EnhanceContrastMode mode, float flashControl, float hlt, SafePtr<CameraNode> camera);
...
public:
	...
	bool m_reduceFlash;
    EnhanceContrastMode m_enhanceContrastMode;
