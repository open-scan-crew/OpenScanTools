...
#define TEXT_EXPORT_TITLE_COLORIMETRIC_FILTER QObject::tr("Colorimetric Filter Export")
...
#define TEXT_COLORIMETRIC_FILTER_ACTIVATE_FIRST QObject::tr("Please activate a colorimetric filter first.")
...
#define TEXT_EXPORT_STAT_OUTLIER_TITLE_PROGESS QObject::tr("Statistical Outlier Filter")
#define TEXT_EXPORT_COLOR_BALANCE_TITLE_PROGRESS QObject::tr("Color balance")
#define TEXT_EXPORT_COLORIMETRIC_FILTER_TITLE_PROGRESS QObject::tr("Colorimetric Filter Export")
