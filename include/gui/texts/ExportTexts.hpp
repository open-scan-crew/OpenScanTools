...
#define TEXT_EXPORT_TITLE_FILTERED_SCANS QObject::tr("Filtered Scans Export")
...
#define TEXT_FILTER_ACTIVATE_FIRST QObject::tr("Please activate a filter first.")
...
#define TEXT_EXPORT_FILTERED_SCANS_TITLE_PROGRESS QObject::tr("Filtered Scans Export")
