...
public:
    void setAnimationOptions(VideoAnimationMode mode, int length, bool interpolateRenderings);
...
private:
	...
	VideoAnimationMode m_animationMode = VideoAnimationMode::ORBITAL;
	int m_animationLengthS = 30;
