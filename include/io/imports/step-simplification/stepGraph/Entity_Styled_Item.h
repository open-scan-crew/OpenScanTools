...
#ifndef ENTITY_STYLED_ITEM_H
#define ENTITY_STYLED_ITEM_H
 ...
 * Entity STYLED_ITEM
 */
class Entity_Styled_Item : public Entity {

public:
    Entity_Styled_Item(unsigned int _id, const std::string& _name, const std::string& _arguments);
