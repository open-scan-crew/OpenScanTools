 ...
 */
class Entity_Adv_B_Sh_Rep : public Entity {

public:
    Entity_Adv_B_Sh_Rep(unsigned int _id, const std::string& _name, const std::string& _arguments);
