...
public:
    ClassificationStrategy(StepGraph* _stepGraph) : stepGraph(_stepGraph) {};

    inline StepGraph* getStepGraph() { return stepGraph; }

    virtual ~ClassificationStrategy() {}
    virtual std::list<std::list<StepPiece*>> classify() = 0;
};
