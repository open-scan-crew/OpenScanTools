...
#define Key_ViewPoint_Object_States		"ViewPointObjectStates"
#define Key_ViewPoint_Object_Transform	"ObjectTransform"
#define Key_ViewPoint_Object_Clip		"ObjectClipDistances"
#define Key_ViewPoint_Object_Ramp		"ObjectRampDistances"
