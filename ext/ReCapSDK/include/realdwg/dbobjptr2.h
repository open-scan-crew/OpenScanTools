...
template<class ACDB_CLASS, auto ACDB_GET_CLASS_DESC=ACDB_CLASS::desc> inline Acad::ErrorStatus
...
template<class, auto> class AcDbSmartObjectPointer;
...
//
template<class ACDB_CLASS, auto ACDB_GET_CLASS_DESC=ACDB_CLASS::desc>
...
template<class ACDB_CLASS, auto ACDB_GET_CLASS_DESC> inline
...
template<class ACDB_CLASS, auto ACDB_GET_CLASS_DESC> inline Acad::ErrorStatus
...
template<class ACDB_CLASS, auto ACDB_GET_CLASS_DESC> inline const ACDB_CLASS *
...
// allowed to.
template<class ACDB_CLASS, auto ACDB_GET_CLASS_DESC> inline ACDB_CLASS *
...
template<class ACDB_CLASS, auto ACDB_GET_CLASS_DESC> inline void
